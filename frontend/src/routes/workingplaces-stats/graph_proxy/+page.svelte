<script>
    ...
    let API = "https://sos2223-dic-pvl.ew.r.appspot.com/api/v2/workingplaces-stats/proxy/?url=https://sos2223-22.appspot.com/api/v2/jobs-companies-innovation-stats";
